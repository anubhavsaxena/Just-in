(function () {
    ...
    ui.Pages.define("/pages/groupedCategories/groupedCategories.html", {
        ...
        ready: function (element, options) {
            ...
            var zoomedlistView = element.querySelector('#zoomedinsemanticListView');
            initAppbar();
    ...
    function initAppbar() {
        ...
        document.getElementById('cmdCancel').addEventListener('click',doClickCancel,false);
    }
    //functions bind to command buttons
    ...
    function doDBOperation(items) {
        ...
        request.onupgradeneeded = function (event) {
            ...
            var feedCache = db.createObjectStore('FeedCache', { keyPath: 'grouptitle' });
